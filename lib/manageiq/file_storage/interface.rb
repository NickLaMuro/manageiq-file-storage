...
module ManageIQ
  module FileStorage
    ...
    # implementation where necessary.  Connection will be handled separately by
    # the subclasses, but they must conform to the top level interface.
    #
    class Interface
      ...
      #
      # Classes that inherit from `ManageIQ::FileStorage` need to make sure to
      # create a method that overwrites this one to handle the specifics of
      # uploading for their particular ObjectStore protocol or MountSession.
      #
