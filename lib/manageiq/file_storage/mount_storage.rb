...
module ManageIQ
  class FileStorage
    class MountStorage < FileStorage::Interface
      ...
      require 'manageiq/file_storage/mount_storage/glusterfs'
      ...
      def logger
        @logger ||= $log.nil? ? self.class.logger : $log
      end
      ...
      # TODO:  Redo this so it is "pluggable"
      ...
      # TODO:  Make this a config that doesn't rely on core, which core can
      # call out to in an initializer and set.
